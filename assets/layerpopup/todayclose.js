/* Javascript */
var $layerPopup = document.querySelector('#layerPopupBox');
var $btnLayerPopupClose = document.querySelector('#layerPopupBox .btnClose');
var $btnLayerPopupTodayHide = document.querySelector('#layerPopupBox .btnTodayHide');
